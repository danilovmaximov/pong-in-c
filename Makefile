...
SOURCES = start.c menu.c state_controller.c text_utils.c periphery_utils.c game.c pads.c ball.c countdown.c game_end.c mzapo_phys.c mzapo_parlcd.c serialize_lock.c
...
SSH_OPTIONS=-o 'maksidan@postel.felk.cvut.cz'
